...
try:
    ...
    logger.warning(
        "Warning: Missing modules from 'spaces' app. Using robust mock objects to maintain functionality in bookings/admin/penalty_admin.py. Functionality may be limited.")
