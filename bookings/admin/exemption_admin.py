# bookings/admin/exemption_admin.py (终极修正版 - SpaceManager 只读，严格控制模块可见性)
...
try:
    ...
    logger.warning(
        "Warning: Missing modules from 'spaces' app. Using robust mock objects to maintain functionality in bookings/admin/exemption_admin.py. Functionality may be limited.")
